...
function validatePartialDestination(body) {
  ...
  if (!anyFieldPresent) return ['Nessun campo da aggiornare'];
  ...
  if (hasDurata) {
    ...
    if (typeof durata_giorni !== 'number' || Number.isNaN(durata_giorni) || !Number.isInteger(durata_giorni) || durata_giorni < 1 || durata_giorni > 365) {
...
module.exports = { validateDestination, validatePartialDestination };
